...
func TestCarbon_Format_Layout(t *testing.T) {
	assert := assert.New(t)
	...
	tests := []struct {
		...
		0:  {now.Format(AtomFormat), now.Layout(AtomLayout)},
		1:  {now.Format(ANSICFormat), now.Layout(ANSICLayout)},
		2:  {now.Format(CookieFormat), now.Layout(CookieLayout)},
		3:  {now.Format(KitchenFormat), now.Layout(KitchenLayout)},
		4:  {now.Format(RssFormat), now.Layout(RssLayout)},
		5:  {now.Format(RubyDateFormat), now.Layout(RubyDateLayout)},
		6:  {now.Format(UnixDateFormat), now.Layout(UnixDateLayout)},
		7:  {now.Format(RFC1036Format), now.Layout(RFC1036Layout)},
		8:  {now.Format(RFC1123Format), now.Layout(RFC1123Layout)},
		9:  {now.Format(RFC1123ZFormat), now.Layout(RFC1123ZLayout)},
		10: {now.Format(RFC2822Format), now.Layout(RFC2822Layout)},
		11: {now.Format(RFC3339Format), now.Layout(RFC3339Layout)},
		12: {now.Format(RFC3339MilliFormat), now.Layout(RFC3339MilliLayout)},
		13: {now.Format(RFC3339MicroFormat), now.Layout(RFC3339MicroLayout)},
		14: {now.Format(RFC3339NanoFormat), now.Layout(RFC3339NanoLayout)},
		15: {now.Format(RFC7231Format), now.Layout(RFC7231Layout)},
		16: {now.Format(RFC822Format), now.Layout(RFC822Layout)},
		17: {now.Format(RFC822ZFormat), now.Layout(RFC822ZLayout)},
		18: {now.Format(RFC850Format), now.Layout(RFC850Layout)},
		19: {now.Format(ISO8601Format), now.Layout(ISO8601Layout)},
		20: {now.Format(ISO8601MilliFormat), now.Layout(ISO8601MilliLayout)},
		21: {now.Format(ISO8601MicroFormat), now.Layout(ISO8601MicroLayout)},
		22: {now.Format(ISO8601NanoFormat), now.Layout(ISO8601NanoLayout)},
		23: {now.Format(DayDateTimeFormat), now.Layout(DayDateTimeLayout)},
		24: {now.Format(DateTimeFormat), now.Layout(DateTimeLayout)},
		25: {now.Format(DateTimeMilliFormat), now.Layout(DateTimeMilliLayout)},
		26: {now.Format(DateTimeMicroFormat), now.Layout(DateTimeMicroLayout)},
		27: {now.Format(DateTimeNanoFormat), now.Layout(DateTimeNanoLayout)},
		28: {now.Format(ShortDateTimeFormat), now.Layout(ShortDateTimeLayout)},
		29: {now.Format(ShortDateTimeMilliFormat), now.Layout(ShortDateTimeMilliLayout)},
		30: {now.Format(ShortDateTimeMicroFormat), now.Layout(ShortDateTimeMicroLayout)},
		31: {now.Format(ShortDateTimeNanoFormat), now.Layout(ShortDateTimeNanoLayout)},
		32: {now.Format(DateFormat), now.Layout(DateLayout)},
		33: {now.Format(DateMilliFormat), now.Layout(DateMilliLayout)},
		34: {now.Format(DateMicroFormat), now.Layout(DateMicroLayout)},
		35: {now.Format(DateNanoFormat), now.Layout(DateNanoLayout)},
		36: {now.Format(ShortDateFormat), now.Layout(ShortDateLayout)},
		37: {now.Format(ShortDateMilliFormat), now.Layout(ShortDateMilliLayout)},
		38: {now.Format(ShortDateMicroFormat), now.Layout(ShortDateMicroLayout)},
		39: {now.Format(ShortDateNanoFormat), now.Layout(ShortDateNanoLayout)},
		40: {now.Format(TimeFormat), now.Layout(TimeLayout)},
		41: {now.Format(TimeMilliFormat), now.Layout(TimeMilliLayout)},
		42: {now.Format(TimeMicroFormat), now.Layout(TimeMicroLayout)},
		43: {now.Format(TimeNanoFormat), now.Layout(TimeNanoLayout)},
		44: {now.Format(ShortTimeFormat), now.Layout(ShortTimeLayout)},
		45: {now.Format(ShortTimeMilliFormat), now.Layout(ShortTimeMilliLayout)},
		46: {now.Format(ShortTimeMicroFormat), now.Layout(ShortTimeMicroLayout)},
		47: {now.Format(ShortTimeNanoFormat), now.Layout(ShortTimeNanoLayout)},
	}

	for index, test := range tests {
		assert.Equal(test.expected, test.actual, "Current test index is "+strconv.Itoa(index))
	}
