...
func TestCarbon_MarshalJSON_SetTag(t *testing.T) {
	tag := NewTag()
	tag.SetLayout(RFC3339Layout).SetTimezone(PRC)
	now := Parse("2020-08-05 13:14:15.999999999", PRC).SetTag(tag)
	...
	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday1.String())
	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday2.String())
	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday3.String())
	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday4.String())

	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday5.String())
	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday6.String())
	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday7.String())

	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday8.String())
	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday9.String())
	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday10.String())

	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday11.String())
	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday12.String())
	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday13.String())

	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday14.String())
	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday15.String())
	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday16.String())
	assert.Equal(t, "2020-08-05T13:14:15+08:00", person.Birthday17.String())

	fmt.Printf("person output by json:\n%s\n", data)
}

func TestCarbon_UnmarshalJSON_SetTag(t *testing.T) {
	tag := NewTag()
	tag.SetLayout(RFC3339Layout).SetTimezone(PRC)
	...
	str := `{
		"name":"gouguoyin",
		"age":18,
		"birthday1":"2020-08-05T13:14:15+08:00",
		"birthday2":"2020-08-05T13:14:15+08:00",
		"birthday3":"2020-08-05T13:14:15+08:00",
		"birthday4":"2020-08-05T13:14:15+08:00",
		"birthday5":"2020-08-05T13:14:15+08:00",
		"birthday6":"2020-08-05T13:14:15+08:00",
		"birthday7":"2020-08-05T13:14:15+08:00",
		"birthday8":"2020-08-05T13:14:15+08:00",
		"birthday9":"2020-08-05T13:14:15+08:00",
		"birthday10":"2020-08-05T13:14:15+08:00",
		"birthday11":"2020-08-05T13:14:15+08:00",
		"birthday12":"2020-08-05T13:14:15+08:00",
		"birthday13":"2020-08-05T13:14:15+08:00",
		"birthday14":"2020-08-05T13:14:15+08:00",
		"birthday15":"2020-08-05T13:14:15+08:00",
		"birthday16":"2020-08-05T13:14:15+08:00",
		"birthday17":"2020-08-05T13:14:15+08:00"
	}`
