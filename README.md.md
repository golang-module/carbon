...
> According to the meteorological division method, March to May is spring, June to August is summer, September to
> November is autumn, and December to February is winter
...
> library [embed](https://pkg.go.dev/embed) after `golang1.16`. If your golang version is `1.16+`, the v2 is recommended,
> otherwise, the v1 is required.
...
`Carbon` is a non-commercial open source project. If you want to support `Carbon`, you
